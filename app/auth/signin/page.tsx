...
export default function SignInPage() {
  ...
  async function handleSignIn() {
    setLoading(true);
    // Redirect straight to GitHub — no intermediate NextAuth page.
    await signIn('github', { callbackUrl: '/' });
  }

  return (
    <div className="si-shell">
      {/* Layered ambient glow — matches public/index.html canvas */}
      ...
      <div className="si-card" role="main">
        ...
        >
          {loading ? (
            <span className="si-btn-spinner" aria-hidden="true" />
          ) : (
            <GitHubMark size={17} />
          )}
